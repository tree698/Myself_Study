...
// Q1. make a string out of an array
{
	...
	const result1 = console.log(result1);
}

// Q2. make an array out of a string
{
	const fruits = '🍊, 🥝, 🍌, 🍒';
	const result2 = console.log(result2);
}

// Q3. make this array look like this: [5,4,3,2,1]
{
	const array = [1, 2, 3, 4, 5];
	const result3 = console.log(result3);
	console.log(array);
}
...
{
	const array = [1, 2, 3, 4, 5];
	const result41 = console.log(result41);
}
...
{
	const result5 = console.log(result5);
}

// Q6. make an array of enrolled students
{
	const result6 = console.log(result6);
}

// Q7. make an array containing only the students' scores
// result should be: [45, 80, 90, 66, 88]
{
	const result7 = console.log(result7);
}

// Q8. check if there is a student with the score lower than 50
{
	const result8 = console.log(result8);
}

// Q9. compute students' average score
{
	const result9 = console.log(result9 / students.length);
}

// Q10. make a string containing all the scores
// result shold be: '45,80,90,66,88'
{
	const result10 = console.log(result10);
}
